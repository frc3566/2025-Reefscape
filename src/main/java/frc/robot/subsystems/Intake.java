...
public class Intake extends SubsystemBase{
    ...
    public final static SparkMax pivot =  new SparkMax(14, MotorType.kBrushless);
    public final RelativeEncoder intakeEncoder = intake.getEncoder();
    public final static RelativeEncoder rotationEncoder = pivot.getEncoder();
