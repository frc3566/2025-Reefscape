...
public class CenterTwoCoral extends SequentialCommandGroup{
    public CenterTwoCoral(SwerveSubsystem swerve, Elevator elevator, Intake intake) {
        List<Command> cmds = List.of(
            new ParallelCommandGroup(
                new DriveToReefAbsoluteAuto(swerve,ReefUtil.Side.BARGE, ReefUtil.LeftRight.LEFT),
