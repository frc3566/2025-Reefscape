...
public class RobotRoutine {
  ...
  public void configureBindings() {
    ...
    m_driverController.a().whileTrue(m_elevator.runQuasistatic(true));
    m_driverController.b().whileTrue(m_elevator.runQuasistatic(false));
    m_driverController.x().whileTrue(m_elevator.runDynamic(true));
    m_driverController.y().whileTrue(m_elevator.runDynamic(false));
  }
